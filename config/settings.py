...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-g^237maporb6+y3p@04_&)d!p10^!u%$w(b6$ganthm@vr(c_u')
...
UNFOLD = {
    ...
    "SITE_URL": "/",
    "DASHBOARD_CALLBACK": "invoices.dashboard.get_dashboard_stats",
    "COLORS": {
        "primary": {
            "50": "245 248 244",
            "100": "236 241 233",
