...
print(f"1200.00 -> {currency_de(1200.00)}")
print(f"1200.50 -> {currency_de(1200.50)}")
print(f"1000000 -> {currency_de(1000000)}")
print(f"1.5 -> {currency_de(1.5)}")
print(f"None -> '{currency_de(None)}'")
